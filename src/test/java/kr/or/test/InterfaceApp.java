...
public class InterfaceApp {
	...
	public static void main(String[] args) {
		// 자바프로그램은 항상 main() 집입점에서 실행하는것. 단, 웹프로그램은 해당안됨.
		AllCalc allCalc = new AllCalc();//실행 오브젝트 allCalc 생성
		allCalc.add(5, 5);
		allCalc.sub(5, 5);
		allCalc.mul(5, 5);
		allCalc.div(5, 5);
...
class AllCalc implements CalcAddSub, CalcMulDiv {
	...
	@Override
	public void div(double dx, double du) {
		// 구현내용
