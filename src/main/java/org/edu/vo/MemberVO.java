...
public class MemberVO {
	...
	//member_write.jsp에서 전송값이 point가 빈값으로 올때, int형은 에러발생,Integer형은 에러없이 지나감.
	...
	//get,set 메서드가 필요한 이유는 member_list(write).jsp<-겟셋메서드->컨트롤러<-겟셋메서드->DB
