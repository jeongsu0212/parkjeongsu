          ...
          <div class="col-12"><!-- 그리드시스템중 12가로칼럼중 width=100% -->
	       	...
	       	<div class="card card-primary">
	              ...
	              <div class="card-body">
	                ...
	                <p class="text-muted">
	                <!-- jsp에서 자바변수(저장소)를 사용하는 방법 Model로 수신한 $ user_id2 변수명으로 시작합니다.-->
	                <%--${user_id2} 아래 보안코딩 적용--%>
					...
					<!-- 부트스트랩 오른쪽여백주기 클래스명 mr-1(margin-right: .25rem!important;)  -->
	                <hr>
	                ...
	                <hr>
	                <strong><i class="fab fa-battle-net mr-1"></i> enabled</strong>	
		            <p class="text-muted">${memberVO.enabled}</p>	
		            
		            <hr>
	                <strong><i class="fas fa-award mr-1"></i> levels</strong>	
		            <p class="text-muted">${memberVO.levels}</p>	            
		          </div>
	              <!-- /.card-body -->
	          </div>
		<form name="delete_form" id="action_form" action="" method="post">
	  		<!-- 버튼영역 시작 -->
            <div class="card-body">
	            ...
	            <!-- 부트스트랩 버튼클래서 디자인을 이용해서 a태그를 버튼모양으로 만들기(위). -->
	            <!-- btn클래스명이 버튼모양으로 변경, btn-primary클래스명은 버튼생삭응 변경하는 역할 -->
            </div>
            <!-- 버튼영역 끝 -->
